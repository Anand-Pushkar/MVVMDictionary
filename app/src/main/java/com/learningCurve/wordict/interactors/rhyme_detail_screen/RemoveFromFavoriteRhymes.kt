...
class RemoveFromFavoriteRhymes(
    ...
    private fun getOrphanedRhymes(rhymesWithRelation: List<RhymeWithAllTheWordsResponse>, allRhymes: List<RhymeEntity>): List<RhymeEntity> {
...
//        val sumList = rhymesWithRelation + allRhymes
//        return sumList.groupBy { it.word }
